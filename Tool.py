...
def get_text_from_text_area_for_encryption():
    ...
    encrypt_text_area.insert("end-1c",user_input)  
...
def get_text_from_text_area_for_decryption():
    ...
    print("User input:", user_input_de)

to_be_encrypt_label = tk.Label(mainframe, text="Encryption Part", relief="groove")
to_be_encrypt_label.grid(row=1, column=0, pady=15)

to_be_decrypt_label = tk.Label(mainframe, text="Decryption Part", relief="groove")
to_be_decrypt_label.grid(row=1, column=1, pady=15)

to_be_encrypt_text_area = tk.Text(mainframe, width=50, height=5, state="normal")
...
save_button = tk.Button(
    ...
    background='Black',
    foreground='White',
    border=5, font=("Cambria", 10, "bold"),command=get_text_from_text_area_for_encryption)
save_button.grid(row=3, column=0, pady=15)

to_be_decrypt_text_area = tk.Text(mainframe, width=50, height=5, state="normal")
...
save_button = tk.Button(
    ...
    background='Black',
    foreground='White',
    border=5, font=("Cambria", 10, "bold"),command=get_text_from_text_area_for_decryption)
...
encrypt_label.grid(row=4, column=0, pady=15)

decrypt_label = tk.Label(mainframe, text="Your Decrypted Message")
decrypt_label.grid(row=4, column=1, pady=15)

encrypt_text_area = tk.Text(mainframe, width=50, height=5)
encrypt_text_area.grid(row=5, column=0, pady=15, padx=15)

decrypt_text_area = tk.Text(mainframe, width=50, height=5)
decrypt_text_area.grid(row=5, column=1, pady=15, padx=15)
...
save_button = tk.Button(
    ...
    background='Black',
    foreground='White',
    border=5, font=("Cambria", 10, "bold"),command=save_encrypting_mesage)
...
save_button = tk.Button(
    ...
    background='Black',
    foreground='White',
    border=5, font=("Cambria", 10, "bold"),command=save_decrypting_mesage)
save_button.grid(row=6, column=1, pady=15)
###########################################
#########################################
